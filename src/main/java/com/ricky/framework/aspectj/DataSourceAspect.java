package com.ricky.framework.aspectj;
...
public class DataSourceAspect
{
    ...
    @Pointcut("@annotation(com.ricky.framework.aspectj.lang.annotation.DataSource)"
            + "|| @within(com.ricky.framework.aspectj.lang.annotation.DataSource)")
